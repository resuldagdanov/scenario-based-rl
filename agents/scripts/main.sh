...
export repetitions=50 #50
export max_episode_batch_num=50 #20
export json_file="all_towns_traffic_scenarios_WOR.json" #"town05_all_scenarios.json" #
export xml_file="failed_routes/town05_long/stuck_vehicle_1.xml" #"failed_routes/town03_short/traffic_junction_1.xml"
